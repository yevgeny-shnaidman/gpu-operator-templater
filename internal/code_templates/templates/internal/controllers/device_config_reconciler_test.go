...
import (
	...
	mock_client "${REPO}/internal/client"
...
var _ = Describe("getLabelsPerModules", func() {
	...
	It("good flow", func() {
		expectedDevConfig := ${VENDOR}${VERSION}.DeviceConfig{
		...
		kubeClient.EXPECT().Get(ctx, nn, gomock.Any()).Do(
			func(_ interface{}, _ interface{}, devConfig *${VENDOR}${VERSION}.DeviceConfig, _ ...client.GetOption) {
