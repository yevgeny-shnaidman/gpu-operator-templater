...
import (
	...
	${VENDOR}${VERSION} "${REPO}/api/${VERSION}"
	"${REPO}/internal/kmmmodule"
	"${REPO}/internal/nodelabeller"
	"${REPO}/internal/nodemetrics"
...
const (
	...
	deviceConfigFinalizer      = "${VENDOR}.node.kubernetes.io/deviceconfig-finalizer"
)
...
func (r *DeviceConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&${VENDOR}${VERSION}.DeviceConfig{}).
...
//+kubebuilder:rbac:groups=${GROUP},resources=deviceconfigs,verbs=get;list;watch;create;patch;update
//+kubebuilder:rbac:groups=kmm.sigs.x-k8s.io,resources=modules,verbs=get;list;watch;create;patch;update;delete
//+kubebuilder:rbac:groups=${GROUP},resources=deviceconfigs/finalizers,verbs=update
...
type deviceConfigReconcilerHelperAPI interface {
	...
	finalizeDeviceConfig(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error
	setFinalizer(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error
	handleKMMModule(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error
	handleBuildConfigMap(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error
	handleNodeLabeller(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error
	handleNodeMetrics(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error
}
...
func (dcrh *deviceConfigReconcilerHelper) getRequestedDeviceConfig(ctx context.Context, namespacedName types.NamespacedName) (*${VENDOR}${VERSION}.DeviceConfig, error) {
	devConfig := ${VENDOR}${VERSION}.DeviceConfig{}
...
func (dcrh *deviceConfigReconcilerHelper) setFinalizer(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error {
...
func (dcrh *deviceConfigReconcilerHelper) finalizeDeviceConfig(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error {
	logger := log.FromContext(ctx)
...
func (dcrh *deviceConfigReconcilerHelper) handleBuildConfigMap(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error {
...
func (dcrh *deviceConfigReconcilerHelper) handleKMMModule(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error {
...
func (dcrh *deviceConfigReconcilerHelper) handleNodeLabeller(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error {
	ds := &appsv1.DaemonSet{
...
func (dcrh *deviceConfigReconcilerHelper) handleNodeMetrics(ctx context.Context, devConfig *${VENDOR}${VERSION}.DeviceConfig) error {
	ds := &appsv1.DaemonSet{
...
func getDockerfileCMName(devConfig *${VENDOR}${VERSION}.DeviceConfig) string {
